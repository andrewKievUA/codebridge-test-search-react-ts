...
export const SoloPage = () => {
   ...
   {resServ[0]? console.log(resServ[0].id,"succsses"):console.log("UNsuccsses")}
   

    return (
        <div className="totalContainer">
            {resServ[0]? <div className="imgCard"><img src={resServ[0].imageUrl} alt={"logo"} className="imgCardSolo"/> </div>:null    }
            <div className="containerSolo">
                    
                    {resServ[0]? <div className="titleSolo">{resServ[0].title} <div/> </div>:null    }
